...
const String SSID = "14spencer"; 
//const String Password = "sesameeggroll14spencer";
...
//const String SignalID = "wetly-harlot-ferret";
const String SignalID = "sleepily-leather-ox";
